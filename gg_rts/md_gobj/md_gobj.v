...
pub fn (mut gobj Gobj) begin_moving(grid Grid) {
	...
	gobj.see_range = grid.cell_size*gobj.steps_can_see
}
...
pub fn (gobj Gobj) is_hp_changed() bool {
	return gobj.old_hp != gobj.hp
}

pub fn (gobj Gobj) is_hp_zero() bool {
	return gobj.hp <= 0
}
