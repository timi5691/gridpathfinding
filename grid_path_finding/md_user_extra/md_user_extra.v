...
import gg
import gx
import my_extra {Vec2, Rect, guipos_to_realpos, is_pos_in_rect, is_rect_in_rect}
import md_animated_sprite{AnimatedSprite, ActionFrame}
import md_grid {Grid}
import md_gobj {Gobj}
	...
	for i in 0..n {
		...
		mut gobj := Gobj{
			...
			aspr: AnimatedSprite{
				...
				action_map: {
					'moving': [
						ActionFrame{img_name: 'test_unit' tile_x: 0 tile_y: 0 tile_w: 32, tile_h: 32},
						ActionFrame{img_name: 'test_unit' tile_x: 0 tile_y: 32 tile_w: 32, tile_h: 32},
...
pub fn check_gobj_player_selected(mut gobj Gobj, left_mouse_pressed bool, left_mouse_released bool, select_area_rect Rect, mouse_pos Vec2, cell_size f32, double_click_selecting bool, double_click_select_gteam int, double_click_select_gtype string) {
	...
	if double_click_selecting {
		if gobj.team == double_click_select_gteam && gobj.gobj_type == double_click_select_gtype && gobj.in_cam_view {
